...
public class PayResult {
    ...
    public String failedReason; //订单失败原因

    public PayResult() {
    }

    public PayResult(String orderId, String cardId, BigDecimal moneyCost, BigDecimal balance, Date orderDate, int orderStatus, String failedReason) {
